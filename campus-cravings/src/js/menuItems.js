export const menuItems = {
    ...
    Chips: [
        ...
        },
        {
            ...
            "image" : "lays_chips.png",
            "price" : "$2.00"
        },
        {
            "name" : "KETCHUP LAYS CHIPS",
            "image" : "laysketchup_chips.png",
            "price" : "$2.00"
        },
        {
            "name" : "CLASSIC DORITOS",
            "image" : "doritos_chips.png",
            "price" : "$2.00"
        },
        {
            "name" : "ALL DRESSED RUFFLES CHIPS",
            "image" : "ruffles_chips.png",
            "price" : "$2.00"
        },
    ],
    Drinks: [
        ...
        {
            "name" : "COKE ZERO",
            "image" : "cokezero_can.png",
            "price" : "$2.50"
        },
        {
            "name" : "SPRITE",
            "image" : "sprite_can.png",
            "price" : "$2.50"
        },
    ],
    Sweets: [
